...
from dnn.util import resizeNormalize ,strLabelConverter
...
crnn = CRNN( 32, 1, nclass, 256, leakyRelu=False,lstmFlag=LSTMFLAG,GPU=False,alphabet=alphabet)
crnn.load_weights(ocrPath)

imgDir = 'E:/work/Item/OCR/text_renderer-master/text_renderer-master/output/default/'
img=Image.open(imgDir + '00000000.jpg')
#img=cv2.imread(imgDir + '00000000.jpg')
raw = crnn.predict(img)
print(raw)
'''